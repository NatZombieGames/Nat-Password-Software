...
/** @type {string} */
const CACHE_VERSION = '1727122095|2214651999';
/** @type {string} */
const CACHE_PREFIX = 'Nat Password Sof-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'NatPasswordSoftware.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["NatPasswordSoftware.html","NatPasswordSoftware.js","NatPasswordSoftware.offline.html","NatPasswordSoftware.icon.png","NatPasswordSoftware.apple-touch-icon.png","NatPasswordSoftware.worker.js","NatPasswordSoftware.audio.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHABLE_FILES = ["NatPasswordSoftware.wasm","NatPasswordSoftware.pck"];
